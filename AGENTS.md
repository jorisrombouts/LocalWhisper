...
- Baseline on an M4 Pro: engine load about 1.3 s, whisper about 0.9 s per dictation, cleanup about 0.5 s plus 30 ms per second of audio (its timeout is 1.5 s plus 50 ms per second). Numbers far above these are a regression.
