...
- Whisper hallucinates on silence ("Thank you.", "you"): clips whose loudest 100 ms stays under 0.005 RMS are skipped, segments with `no_speech_prob >= 0.6` and punctuation-only output are dropped. The log line `whisper rms= peak=` is the calibration data.
